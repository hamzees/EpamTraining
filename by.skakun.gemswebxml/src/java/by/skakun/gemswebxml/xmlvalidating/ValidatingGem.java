package by.skakun.gemswebxml.xmlvalidating;
...
public class ValidatingGem {
    ...
    private String filename = "src/resources/necklace.xml";//"src/resources/necklace.xml";
    ...
    public String ValidatingNecklace() {
    String s1 = null;
